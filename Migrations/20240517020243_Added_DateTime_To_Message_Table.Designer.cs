...
namespace Syncord.Migrations
{
    ...
    [Migration("20240517020243_Added_DateTime_To_Message_Table")]
    partial class Added_DateTime_To_Message_Table
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Syncord.Models.FriendShip", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Syncord.Models.Message", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Syncord.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Syncord.Models.FriendShip", b =>
                {
                    b.HasOne("Syncord.Models.User", "User1")
                        .WithMany("FriendShips")
                        .HasForeignKey("UserId1")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Syncord.Models.User", "User2")
                        .WithMany()
            ...
            modelBuilder.Entity("Syncord.Models.Message", b =>
                {
                    b.HasOne("Syncord.Models.FriendShip", "FriendShip")
                        .WithMany("Messages")
